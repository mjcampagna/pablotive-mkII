...
class Image extends React.Component {
	...
	handleGenerate(event) {
		...
		this.setState({
			...
			const src = this.state.image.urls.regular;
			const cfg = {
			...
			<React.Fragment>
						...
						<div id="output">
							<div className="original" id="original" style={{ display: this.state.view === 'original' ? 'block' : 'none'}}>
								<img src={this.state.image.urls.regular} crossOrigin="anonymous" />
							</div>
				...
				/>
				<p className="photographer-name">Photo by {this.state.image.user.name}</p>
